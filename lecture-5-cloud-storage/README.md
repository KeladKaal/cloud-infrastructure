...
Здравствуйте, коллеги. Это пятая лекция курса «Облачная инфраструктура». В лекции 3 мы построили сетевое ядро облака — разобрали виртуализацию сетей, балансировщики, шлюзы. Но сеть — это ещё не всё: по сети надо что-то передавать. И сегодня мы говорим о главном ресурсе любого облака — **о хранении данных**.
