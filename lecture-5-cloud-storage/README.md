# Lecture 5 — Cloud data storage

> 👥 **Lecture by the co-instructor.** Below is the author's original lecture text, in Russian and unchanged.
>
> Inside the text the author uses their own numbering — this is their lecture No. 2. For the number mapping and the overall plan see the [course README](../README.md). Submission and report rules differ between the two halves of the course: see [Course rules](../COURSE-RULES.md).

**Lab:** [Lab 5 — Cloud storage (Block, File, Object: choosing and applying)](lab.md)
...
## Часть 1. Три типа хранилищ (20 минут)
...
## Часть 2. Сервисы и аналоги: EBS, EFS, S3 (20 минут)
...
## Часть 3. Производительность vs стоимость (5 минут)
...
## Часть 4. Распространённые сценарии (5 минут)
...
## Часть 5. Резюме и правила выбора (5 минут)
