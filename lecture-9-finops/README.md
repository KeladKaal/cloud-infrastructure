...
Здравствуйте, коллеги. Это девятая лекция курса «Облачная инфраструктура». Мы уже построили сеть (лекция 3), разобрались с хранилищами данных (лекция 5), обеспечили безопасность (лекция 7) — а сегодня разберём то, о чём любят забывать инженеры, но что чаще всего «валит» бюджеты стартапов и корпораций: **управление затратами в облаке**, или **FinOps**.
...
- указывать теги в IaC — тогда они не потеряются;
