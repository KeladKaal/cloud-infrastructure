# Лекция 9 — Управление затратами (FinOps)

> 👥 **Лекция второго преподавателя.** Ниже — авторский текст лекции, он приведён без изменений.
>
> Внутри текста автор пользуется своей сквозной нумерацией — это его лекция №4. Соответствие номеров и общий план — в [README курса](../README.md). Правила сдачи и оформления отчётов в двух половинах курса различаются: см. [«Регламент курса»](../COURSE-RULES.md).

**Лабораторная:** [Лаба 9 — Управление затратами в облаке (FinOps): ценообразование, распределение затрат, оптимизация](lab.md)

---

## Вступление (5 минут)

Здравствуйте, коллеги. Это четвёртая лекция курса «Организация и управление облачной инфраструктурой». Мы уже построили сеть (лекция №1), написали IaC (лекция №2), обеспечили безопасность (лекция №3) — а сегодня разберём то, о чём любят забывать инженеры, но что чаще всего «валит» бюджеты стартапов и корпораций: **управление затратами в облаке**, или **FinOps**.
...
За 60 минут мы пройдём четыре больших блока:
...
## Часть 1. Модели ценообразования (15 минут)
...
## Часть 2. Cost Allocation — распределение затрат (15 минут)
...
## Часть 3. Инструменты мониторинга затрат (15 минут)
...
## Часть 4. Оптимизация затрат (10 минут)
...
## Итоговый цикл FinOps и резюме (5 минут)
