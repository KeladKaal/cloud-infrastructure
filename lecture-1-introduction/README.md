...
👥 — lectures by the course's co-instructor.
...
- **Design** (3, 5, 7, 9, 11) — you design an architecture for the "Book World" online store, justify your choices, calculate costs and submit a report with a schematic. These labs form a chain: each one builds on the previous.
